...
export const AboutSection = () => {
  return <div className="space-y-4" data-magicpath-id="0" data-magicpath-path="AboutSection.tsx">
      <p data-magicpath-id="1" data-magicpath-path="AboutSection.tsx">I'm the cofounder and CEO of Misogi Labs. We work with pharma and CROs to integrate AI agents in preclinical R&D and IP workflows. We believe that by freeing scientists from everything that isn't science and doesn't require human genius, we can significantly augment the pace of discoveries. For more, check our website or reach out at jessica (at) misogilabs (dot) com.</p>
      ...
      <p data-magicpath-id="7" data-magicpath-path="AboutSection.tsx">
